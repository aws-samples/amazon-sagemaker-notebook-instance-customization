...
3. [restart the Jupyter process](#51-restart-jupyterlab).
...
- Tree-like file explorer (thanks to
  [jupyterlab-unfold](https://github.com/jupyterlab-contrib/jupyterlab-unfold)).

  ![Screenshot courtesy of jupyterlab-unfold](https://raw.githubusercontent.com/jupyterlab-contrib/jupyterlab-unfold/master/images/screenshot.png)
...
- Enable code formatting (thanks to
  ...
  ![Screenshot courtesy of jupyterlab-code-formatter](https://github.com/ryantam626/jupyterlab_code_formatter/raw/master/docs_src/_static/format-all.gif)
